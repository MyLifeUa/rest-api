...
urlpatterns = [
    ...
    # Health Statistics
    url("^health-stats/nutrients/ratio/(?P<date>.+)", nutrients_ratio, name="nutrients-ratio"),
    url("^health-stats/nutrients/total/(?P<date>.+)", nutrients_total, name="nutrients-total"),
]
